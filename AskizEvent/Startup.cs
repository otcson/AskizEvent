...
namespace AskizEvent
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IApplication, ApplicationRepository>();
            services.AddTransient<IRoles, RolesRepository>();
            services.AddTransient<IStatuses, StatusesRepository>();
            services.AddTransient<ITypeEvent, TypeEventRepository>();
